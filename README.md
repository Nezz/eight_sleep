...
You can leave the client_id and/or client_secret blank when setting up the integration.

> [!NOTE]
> If you really want to set your own, you can capture the login POST request from the app to auth-api.8slp.net.
